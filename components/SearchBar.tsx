          ...
          <div className="relative group">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-300 placeholder-gray-400"
              />
              {filters.cidade && (
                <button
          ...
          <div className="relative group">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Ex: Maratona, Meia Maratona, 10K"
                className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-300 placeholder-gray-400"
              />
              {filters.nome && (
                <button
          ...
          <div className="relative group">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Ex: 2024, Janeiro, Março"
                className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-300 placeholder-gray-400"
              />
              {filters.data && (
                <button
